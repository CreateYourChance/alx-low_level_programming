...
/**
 * main - Copies the contents of a file o another file.
 * @argc: The number of arguments supplied to the prograù.
 * @argv: An array of pointers to the arguments.
 *
 * Return: 0 on success.
 *
 * Description: if the argument count is incorreect - exist code 97.
